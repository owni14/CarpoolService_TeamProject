		...
		kakao.maps.event.addListener(map, 'click', function(mouseEvent) {
    		searchDetailAddrFromCoords(mouseEvent.latLng, function(result, status) {
		        if (status === kakao.maps.services.Status.OK) {
		            document.getElementById("startLocat").value = result[0].address.address_name;;
		        }   
		    });
		});
		// test
	...
	<h3 style="text-align: center;">지도에서 출발 위치를 클릭해주세요.</h3>
		<form role="form">
			<div class="form-group" style="margin-bottom: 10px;">
				<label for="startLocation"> 출발위치 </label> 
				<input type="text" class="form-control" id="startLocat" name="startLocation" readonly="readonly"/>
			</div>
			<div class="form-group" style="margin-bottom: 10px;">
